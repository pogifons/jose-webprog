...
const Layout = () => {
  ...
  return (
    <div className="pet-bg flex min-h-screen flex-col">
      <NavBar />
      ...
      <footer className="border-t-2 bg-[color:var(--pet-paper)]" style={{ borderColor: 'var(--pet-border)' }}>
        <div className="pet-container py-10">
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div>
              ...
              <ul className="mt-3 space-y-2 text-sm text-[color:rgba(27,26,22,0.72)]">
                ...
                <li>
                  <Link className="hover:underline hover:underline-offset-4" to="/articles">Articles</Link>
                </li>
              </ul>
            </div>
          ...
          >
            <p className="text-xs text-[color:rgba(27,26,22,0.56)]">
